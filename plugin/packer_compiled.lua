...
_G.packer_plugins = {
  ["HTML-AutoCloseTag"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/HTML-AutoCloseTag",
  ...
  nerdtree = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/onedark.vim",
  ...
  ["toggle-lsp-diagnostics.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/toggle-lsp-diagnostics.nvim",
    url = "https://github.com/WhoIsSethDaniel/toggle-lsp-diagnostics.nvim"
  },
  ["vim-clang-format"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/vim-clang-format",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/vim-devicons",
